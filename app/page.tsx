  ...
  return (
    <>
      ...
      <main>
        ...
        {/* CTA Section */}
        <section className="py-16 sm:py-20 bg-emerald-700 text-white">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <Link
              href="/contact"
              className="inline-flex items-center gap-2 bg-white text-emerald-700 px-8 py-3.5 rounded-lg text-lg font-medium hover:bg-emerald-50 transition-colors"
            >
