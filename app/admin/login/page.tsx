    ...
    <div className="w-full max-w-sm">
      <div className="bg-white rounded-xl shadow-lg p-8">
        ...
        <a
          ...
          className="inline-flex items-center justify-center gap-3 w-full px-4 py-3 bg-white border border-gray-300 rounded-lg text-sm font-medium text-gray-700 hover:bg-gray-50 transition-colors shadow-sm"
        >
